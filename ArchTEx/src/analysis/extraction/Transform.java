...
public class Transform {
	...
	public Transform(ExParameter param) {
		Parameters = param;
	}
	...
	private double[] log2Tran(double[] orig) {
		...
		double avgtag = Parameters.getTotaltagCount()[Parameters.getExp()] / Parameters.getTotalgenomeSize()[Parameters.getExp()];
		double NaNavgtag = (Parameters.getTotaltagCount()[Parameters.getExp()] + 1) / Parameters.getTotalgenomeSize()[Parameters.getExp()];
	...
	private double[] standTran(double[] orig) {
		...
		double ratio = Parameters.getTotaltagCount()[Parameters.getExp()] / Parameters.getStandardWindow();
	...
	private double[] poissonTran(double[] orig) {
		...
		double bpProbability = (Parameters.getTotaltagCount()[Parameters.getExp()]) / Parameters.getTotalgenomeSize()[Parameters.getExp()];
	...
	private double[] gaussTran(double[] orig) {
		...
		double SDSize = Parameters.getSDSize();
		for(int x = 0; x < orig.length; x++) {
             double score = 0;
             double weight = 0;
