...
public class GUI implements ActionListener {
	...
	public GUI() {
		...
		extractionTabbedPane = new JTabbedPane(SwingConstants.TOP);
		extractionTabbedPane.setTabLayoutPolicy(JTabbedPane.SCROLL_TAB_LAYOUT);
		layeredPane.setLayer(extractionTabbedPane, 1);
		extractionPlotsTabbedPane = new JTabbedPane(SwingConstants.LEFT);
		...
		extractionRawTabbedPane = new JTabbedPane(SwingConstants.LEFT);
		...
		//TODO gencorr here
		gencorrTabbedPane = new JTabbedPane(SwingConstants.TOP);
		gencorrTabbedPane.setTabLayoutPolicy(JTabbedPane.SCROLL_TAB_LAYOUT);
		layeredPane.setLayer(gencorrTabbedPane, 0);
		gencorrPlotsTabbedPane = new JTabbedPane(SwingConstants.LEFT);
		...
		gencorrRawTabbedPane = new JTabbedPane(SwingConstants.LEFT);
